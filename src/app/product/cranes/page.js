...
const Page = () => {
  ...
  return (
    <div className="main-container">
      <div className="back-image" id="cranes">
      ...
      <section className="topic-headng">
        <div className="blue-border">
          ...
          <p>
            ...
            Brackets, Crane runway beams & lateraltie that support crane system.
            Clients have to provide complete crane data as per the crane's
            manufacturer for optimal designing of PEB having crane systems.
          </p>
        </div>
      </section>
