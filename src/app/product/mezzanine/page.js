...
const Page = () => {
  ...
  return (
    <div className="main-container">
      <div className="back-image" id="mezanine">
	...
	C-3.6,70.7,1,80.4,9.3,80.4h115h706.4h115C953.9,80.4,958.5,70.7,953.2,64.3z"
      ...
      <section className="topic-headng">
        <div className="blue-border">
          <h1 id="frame">Mezzanine System</h1>
          <p>
            Mezzanine System developed by Devkinandan Steel & metal industries
          ...
          <p>Here are some things to know about mezzanine systems:</p>
          <li>
            <b>Construction</b> : Mezzanine systems can be made from a variety
            of materials, including steel, aluminum, and fiberglass. They can be
            structural, roll formed, rack-supported, or shelf supported.
          </li>
          <li>
            <b>Load capacity</b> : Mezzanine systems can be used for a variety
      ...
      <section className="topic-images">
        <div className="row-one">
          <div className="row-left">
            <h2>1. Deck Sheet Flooring (with RCC):</h2>
            <p>
              Deck Sheets are the preferred choice of flooring not only in steel
          ...
          <div className="row-right">
            <div
              className="img-box"
              onClick={() => {
                openImagePopup("/mezzanine-one.png");
              }}
            >
              <span>
                <h3> Deck Sheet Flooring (with RCC)</h3>
              </span>
              <span>
                <Image
                  id="frame-img-one"
                  className="frame-imgs"
                  src="/mezzanine-one.png"
                  alt=""
                  width={0}
                  height={0}
                  unoptimized
        ...
        <div className="row-two rotate">
          <div className="row-left">
            <h2>2. Chequered Plate Flooring:</h2>
            <p>
          ...
          <div className="row-right">
            ...
            >
              <span>
                <h3>Chequered Plate Flooring</h3>
              </span>
              <span>
                <Image
                  id="frame-img-one"
        ...
        <div className="mezzanine-img">
          <div
            className="img-box"
            onClick={() => {
              openImagePopup("/factory-one.png");
            }}
          >
            <span>
              <Image
          ...
          <div
            className="img-box"
            onClick={() => {
              openImagePopup("/factory-two.png");
            }}
          >
            <span>
              <Image
          ...
          <div
            className="img-box"
            onClick={() => {
              openImagePopup("/factory-three.png");
            }}
          >
            <span>
              <Image
