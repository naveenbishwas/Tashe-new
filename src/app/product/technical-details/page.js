...
const Page = () => {
  ...
  return (
    <div className="main-container">
      <div className="back-image" id="technical">
	...
	C-3.6,70.7,1,80.4,9.3,80.4h115h706.4h115C953.9,80.4,958.5,70.7,953.2,64.3z"
      ...
      <section className="topic-headng">
        <div className="blue-border">
          <h1 id="frame">Canopy & Eave Details</h1>
          <p>
            The most simple eave design features an eave extension that works
            primarily to keep rainwater off exterior walls and away from the
            point where the roof and the wall connect, protecting the sides of
      ...
      <section className="topic-images">
        <div className="row-one">
          <div className="row-left">
            <h2>1. Roof Extension at Eave:</h2>
          </div>
          <div className="row-right">
            <div
              className="img-box"
              onClick={() => {
                openImagePopup("/technical-one.png");
              }}
            >
              <span>
                <h3>Roof Extension at Eave</h3>
              </span>
              <span>
                <Image
                  id="frame-img-one"
        ...
        <div className="row-two rotate">
          <div className="row-left">
            <h2>2. Canopy with Curved Eaves with BoƩ om soffit:</h2>
          </div>
          <div className="row-right">
            <div
              className="img-box"
              onClick={() => {
                openImagePopup("/technical-two.png");
              }}
            >
              <span>
                <h3>Canopy with Curved Eaves with BoƩ om soffit</h3>
              </span>
              <span>
                <Image
                  id="frame-img-one"
                  className="frame-imgs"
                  src="/technical-two.png"
                  alt=""
                  width={0}
                  height={0}
                  unoptimized
        ...
        <div className="row-one">
          <div className="row-left">
            <h2>3. Canopy with Curved Eaves without Bottom om soffit:</h2>
          </div>
          <div className="row-right">
            <div
              className="img-box"
              onClick={() => {
                openImagePopup("/technical-three.png");
              }}
            >
              <span>
                <h3> Canopy with Curved Eaves without Bottom om soffit</h3>
              </span>
              <span>
                <Image
                  id="frame-img-one"
                  className="frame-imgs"
                  src="/technical-three.png"
                  alt=""
                  width={0}
                  height={0}
                  unoptimized
        ...
        <div className="row-two rotate">
          <div className="row-left">
            <h2>4. Canopy with Gutter & Down take without Soffit:</h2>
          </div>
          <div className="row-right">
            <div
              className="img-box"
              onClick={() => {
                openImagePopup("/technical-four.png");
              }}
            >
              <span>
                <h3>Canopy with Gutter & Down take without Soffit</h3>
              </span>
              <span>
                <Image
                  id="frame-img-one"
                  className="frame-imgs"
                  src="/technical-four.png"
                  alt=""
                  width={0}
                  height={0}
                  unoptimized
        ...
        <div className="row-one">
          ...
          <div className="row-right">
            <div
              className="img-box"
              onClick={() => {
                openImagePopup("/technical-five.png");
              }}
            >
              <span>
                <h3>Curved Eave</h3>
