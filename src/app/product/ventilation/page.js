        ...
        <section className="topic-images">
          <div className="row-one">
            <div className="row-left">
              <h2>1. Turbovents:</h2>
              <p>
                Turbovents are dome shaped wind driven venƟ lators which
                provides the desired exit to the hot humid air trapped inside
                the shed. It rotates by the push of the natural draŌ of wind and
                takes out the heat inside the shed. The main advantage of this
                system is that it can be installed or increased in number even
                aŌ er the construcƟ on of shed is complete.
              </p>
            </div>
          ...
          <div className="row-two rotate">
            <div className="row-left">
              ...
              <p>
                ...
                industries. These are integrated into the steel building shed
                and are fabricated along with it. It can be custom made in
                various sizes to suit client’s venƟ laƟ on requirement. It is
                the ideal choice for industries where heat and polluƟ on
                emission is high.
              </p>
            </div>
            <div className="row-right">
          ...
          <div className="row-three">
            <div className="row-left">
              ...
              <p>
                ...
                standard size of 600 mm throat size and 3000 mm length. It can
                be installed at regular interval or conƟ nuously at the ridge
                line of new or old constructed sheds. These are light in weight
                hence does not require any change to exisƟ ng structure. Ridge
                vents are effecƟ ve venƟ laƟ on tool which provides exit of hot
                air from ridge line of the steel buildings
              </p>
            </div>
            <div className="row-right">
              <div
          ...
          <div className="row-two rotate">
            <div className="row-left">
              ...
              <p>
                ...
                high heat generaƟ on. The louvers facilitate huge intake of
                cooler atmospheric air from it surrounding. To facilitate this,
                they have to be sturdily built, preferably along with shed.
                Clients can choose to get them built conƟ nuously or in parƟ
                cular secƟ ons of the shed as required.
              </p>
            </div>
            <div className="row-right">
              <div
          ...
          <div className="row-three">
            <div className="row-left">
              ...
              <p>
                ...
                sheets with size 1.0 M X 3.0 M. Non-standard lengths are
